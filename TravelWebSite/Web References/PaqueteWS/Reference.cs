...
namespace TravelWebSite.PaqueteWS {
    ...
    public partial class PaquetesPopularesWS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public short REGISTROUSUARIO(string Usuarionombre, string Usuariopassword, string Usuarioemail, string Usuariotipologin) {
        ...
        /// <remarks/>
        public void REGISTROUSUARIOAsync(string Usuarionombre, string Usuariopassword, string Usuarioemail, string Usuariotipologin) {
            this.REGISTROUSUARIOAsync(Usuarionombre, Usuariopassword, Usuarioemail, Usuariotipologin, null);
        }
        
        /// <remarks/>
        public void REGISTROUSUARIOAsync(string Usuarionombre, string Usuariopassword, string Usuarioemail, string Usuariotipologin, object userState) {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("Usuarioapellidos")]
        public string OBTNERINFORMACIONADICIONAL(string Usuarioemail, [System.Xml.Serialization.XmlElementAttribute(DataType="date")] out System.DateTime Usuariofechanacimiento, out string Usuariociudadresidencia, out string Usuariotelefono, out string Usuariocelular, out string Usuariopasaporte, [System.Xml.Serialization.XmlElementAttribute(DataType="date")] out System.DateTime Usuariofechavenc, out string Usuariovisa, [System.Xml.Serialization.XmlElementAttribute(DataType="date")] out System.DateTime Usuariovisafechavenc) {
            object[] results = this.Invoke("OBTNERINFORMACIONADICIONAL", new object[] {
                        Usuarioemail});
            Usuariofechanacimiento = ((System.DateTime)(results[1]));
            Usuariociudadresidencia = ((string)(results[2]));
            Usuariotelefono = ((string)(results[3]));
            Usuariocelular = ((string)(results[4]));
            Usuariopasaporte = ((string)(results[5]));
            Usuariofechavenc = ((System.DateTime)(results[6]));
            Usuariovisa = ((string)(results[7]));
            Usuariovisafechavenc = ((System.DateTime)(results[8]));
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void OBTNERINFORMACIONADICIONALAsync(string Usuarioemail) {
            this.OBTNERINFORMACIONADICIONALAsync(Usuarioemail, null);
        }
        
        /// <remarks/>
        public void OBTNERINFORMACIONADICIONALAsync(string Usuarioemail, object userState) {
            ...
            this.InvokeAsync("OBTNERINFORMACIONADICIONAL", new object[] {
                        Usuarioemail}, this.OBTNERINFORMACIONADICIONALOperationCompleted, userState);
        }
